        ...
        <div className="w-full py-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                <div className="text-center mb-20 max-w-2xl mx-auto">
                    ...
                    >
                        {t('center.title_1')} <span className="text-gradient">{t('center.title_2')}</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h3 className="text-3xl font-bold mb-8">{t('center.timings')}</h3>
                        ...
                        <div className="bg-white/[0.03] p-4 rounded-xl border border-white/5 hover:bg-white/[0.06] transition-colors flex items-center gap-3">
                            ...
                            <span className="font-light text-sm text-slate-300">{t('center.other_meetings')}</span>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="absolute inset-0 bg-[#0a0f1d] flex flex-col items-center justify-center p-10 text-center">
                            ...
                            <div className="relative z-10">
                                ...
                                <h4 className="text-2xl font-bold mb-3 text-white">{t('center.visit')}</h4>
                                <p className="text-slate-400 text-base mb-8 max-w-sm font-light">{t('center.visit_desc')}</p>
