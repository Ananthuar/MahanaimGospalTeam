...
const Navbar = () => {
    ...
    const links = [
        { name: 'Home', path: '/' },
        { name: 'Worship Center', path: '/worship-center' },
        { name: 'Programmes', path: '/programmes' },
        { name: 'Worship Team', path: '/worship-team' },
            ...
            <div className="container mx-auto px-6 h-24 flex items-center justify-between">
                <Link to="/" className="flex items-center gap-4 relative z-10 group">
                    ...
                    <span className="font-bold text-lg tracking-tight text-white flex flex-col leading-tight">
                        Mahanaim Gospel <span className="font-light text-slate-300 text-sm">Ministries International</span>
                    </span>
                </Link>
...
const Footer = () => (
    <footer className="border-t border-white/10 mt-24 py-16 relative overflow-hidden bg-[#0a0f1d]">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10 text-center md:text-left">
            <div>
                <h3 className="text-xl md:text-2xl font-extrabold mb-2 tracking-tight text-white">Mahanaim Gospel <br className="hidden md:block" /><span className="font-light text-slate-400">Ministries International</span></h3>
                <p className="text-slate-400 text-base max-w-md mx-auto md:mx-0 font-light leading-relaxed">
                    Transforming lives through powerful worship, global outreach, and deeply rooted community service.
                </p>
            </div>
